...
train = getTrainingSet("C:\\Python\\Training\\GIT\\InformationExtraction\\Images\\OCROutput\\taggedData3.csv")
##print('*'*80)
##print(type(train))
#print(train)
...
with nlp.disable_pipes(*disable_pipes):
    ...
    nlp.to_disk("C:\\Python\\Training\\GIT\\InformationExtraction\\TrainedModelLibrary\\TrainedModelV11")
t2 = time.localtime()
